...
function Sabyr({ posts }) {
  ...
  return (
    <div className="mx-auto">
      <Head>
        <title>{customConfig.blog.author.name}, author at MVPAgency Blog</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={`Sabyr Nurgaliyev, Author at MVPAgency's Blog`}
        />
        <meta
        ...
        <section className="max-w-3xl mx-auto flex flex-col md:flex-row gap-8 mt-12 mb-24 md:mb-32">
          ...
          <div className="max-md:order-first flex md:flex-col gap-4 shrink-0">
            <Image
              ...
              alt={`Sabyr Nurgaliyev - MVPAgency Founder`}
              width={256}
              height={256}
