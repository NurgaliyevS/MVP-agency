...
export function LandingPage() {
  return (
    <div className="min-h-screen">
      {/* Header */}
      <header
        className={`absolute top-0 w-full z-50 transition-colors duration-300 bg-transparent`}
      >
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 class="text-7xl font-extrabold leading-tight tracking-tight">
            From idea to MVP
            <br />{" "}
            <span class="text-highlight inline-block">launch in 7 days</span>
          </h1>

          <div className="max-w-3xl flex items-center justify-center mx-auto flex-col">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center max-w-2xl">
          ...
          <p className="text-neutral-500 mb-8 dark:text-neutral-400">
